...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Copyright 2010 - :current_year, Majestic for Information Technology(in Indien registriert). Alle Rechte vorbehalten.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© Copyright 2010 - :current_year, Majestic for Information Technology(eingetragen in Indien). Alle Rechte vorbehalten.',
                'locale'                 => 'Sprache',
