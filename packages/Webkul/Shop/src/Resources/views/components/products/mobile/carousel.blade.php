...
@pushOnce('scripts')
    ...
    >
    <div 
        class="grid lg:h-[600px] md:h-[500px] h-[70vh] w-screen content-center bg-cover bg-no-repeat" 
        ...
        >
            ...
            <template v-else>
                <img 
                    class="w-full h-full object-cover select-none transition-transform duration-300 ease-in-out" 
